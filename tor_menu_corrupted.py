...
Interactive menu interface for all Tor brow            print("🔄 Testing with current global configuration...")
            
            # Visit the URL mudef browser_config():
    ...
    print("11. 🔙 Back to main menu")igger rotation
            ...
            for i in range(visits):
                ...
                if success:
                    ...
                    print(f"❌ Visit {i+1} failed")n features.
...
# Global configuration - shared between all menu options
    ...
    try:
        if browser.setup():
            ...
            for i, url in enumerate(urls, 1):
                ...
                # Delay between requests (already handled by visit_with_rotation)
